...
function draw() {
  background(220);
  if (autoPlayIsOn && frameCount % renderOnFrameMultipile === 0){
    grid = updateGrid();
  }
  displayGrid();
}
...
// look into why this doesnt work when the above does
// function  updateGrid(){
//   //make new array to hold next turn
//   let nextTurn = generateEmptyGrid(GRID_SIZE,GRID_SIZE);
